      ...
      <Card sx={{ 
        ...
        {isActive && (
          <Chip 
            ...
            color="success" 
            size="small" 
            sx={{ position: 'absolute', top: 10, right: 10, fontWeight: 'bold', fontSize: '0.6rem' }} 
          />
        )}
        <CardContent sx={{ flexGrow: 1 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
            <Box sx={{ p: 1.5, borderRadius: '12px', bgcolor: isActive ? '#dcfce7' : '#f1f5f9', mr: 2 }}>
                <DescriptionIcon sx={{ color: isActive ? '#16a34a' : '#64748b', fontSize: 30 }} />
            </Box>
            <Box sx={{ overflow: 'hidden' }}>
              <Typography variant="h6" component="h2" noWrap title={pmo.nome_identificador} sx={{ fontWeight: 600, fontSize: '1rem' }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
        <Box>
            ...
            <Typography variant="body1" color="text.secondary">
                Visualize, edite ou crie novos planos de manejo para sua propriedade.
            </Typography>
        </Box>
        <Button 
            variant="contained" 
            ...
            sx={{ px: 3, py: 1, fontWeight: 'bold', textTransform: 'none', borderRadius: 2 }}
        >
            Novo Plano
        </Button>
      </Box>
